    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        <Image
          ...
          priority
        />
        {/* Overlay lebih gelap dikit di HP biar teks makin jelas */}
        <div className="absolute inset-0 bg-black/70 md:bg-black/60" /> 
      </div>

      {/* Content */}
      <div className="relative z-10 container mx-auto px-6 text-center md:text-left mt-16 md:mt-0">
        <div className="max-w-3xl">
          ...
          {/* FONT SIZE RESPONSIVE: text-4xl di HP, text-7xl di Desktop */}
